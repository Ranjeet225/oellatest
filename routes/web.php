...
use App\Http\Controllers\{
    CmsController, ProfileController,UserController,RolesController,
    DashboardController,FrenchiseController,FrontendController,
    LeadsManageCotroller,MessageController, OtherMasterDataController,
    ProgramController, StudentController, UniversityController,
    LearningTrainingController,AccountingController,DataOperatorController
};
