...
use App\Mail\{StudentRegistraionMail, FranchiseCreatedStudentProfileMail, StudentProfileCreatedMail, ApplyOel360Email, NewLeadAssignedMail, StudentPaymentMail, PaymentLinkEmail, assignLeadsMail};
use App\Models\{User, MasterService, Student, StudentByAgent, MasterLeadStatus, ProgramPaymentCommission, Caste, VisaSubDocument, Subject, Country, Currency, Province, Payment, Source, EducationLevel, PaymentsLink, Intrested, Fieldsofstudytype, University, Program, ApplicationsApplied, StudentScholorship, Exam, ProgramLevel, VisaDocument};
use Carbon\Carbon;
use Gate;
use Hash;
