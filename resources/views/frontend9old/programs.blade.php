                        ...
                        <div class="search_dropdown d-flex justify-content-around mt-5">
                            ...
                            <div class="dropdown">
                                <select class="form-select" name="program_id" aria-label="Default select example">
                                    ...
                                    <option value="{{$item->id}}">{{Str::limit($item->name, 20, '...')}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="col-lg-4">
                                    <div class="program_title_honors p-3">
                                        ...
                                        <div class="fees_structure mt-4">
                                            <ul>
                                                <li><img src="${assetBaseUrl}frontend/img/icon.png"><a href=""> <span span class="mx-2">Level ${item.program_level?.name}</></a></li>
                                                <li><img src="${assetBaseUrl}frontend/img/icon (1).png" ><a href=""><span span class="mx-4">Duration ${item.length} month</ ></a></li>
                                                <li><img src="${assetBaseUrl}frontend/img/icon (2).png" ><a href=""><span class="mx-3">Application Fees ${item.application_fee}</span></a></li>
                                                <li><img src="${assetBaseUrl}frontend/img/icon (2).png" ><a href=""><span class="mx-3">1st Year Tuition Fees ${item.currency}  ${item.tution_fee}</span></a></li>
                                                <li class="border-bottom-0"><img src="${assetBaseUrl}frontend/img/icon (3).png" ><a href=""><span class="mx-4">Exams Required ${item.university_name?.testrequired}</span></a></li>
                                            </ul>
                                        </div>
                                        <hr>
