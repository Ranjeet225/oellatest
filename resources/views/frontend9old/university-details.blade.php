                        ...
                        <div class="left_article bg-white">
                            ...
                            <div class="all_list_h">
                                <ul>
                                    ...
                                    <li class="duration-feature ">
                                        <i class="fa fa-globe"></i>
                                        <span class="label">Website {{$about_university->website ?? null}}</span>
                                ...
                                <div class="cards " ">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                                ...
                                                <button class="nav-link {{ !isset($_GET['tab']) ? 'active' : '' }}" id="nav-home-tab" data-bs-toggle="tab"
                                                    data-bs-target="#nav-home" type="button" role="tab"
                                                    aria-controls="nav-home" aria-selected="true">Home</button>

                                                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                                    data-bs-target="#nav-profile" type="button" role="tab"
                                                    aria-controls="nav-profile" aria-selected="false">Programs</button>

                                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                                    data-bs-target="#nav-contact" type="button" role="tab"
                                                    aria-controls="nav-contact" aria-selected="false">Gallery</button>

                                                <button class="nav-link" id="nav-contacts-tabs" data-bs-toggle="tab"
                                                    data-bs-target="#nav-contacts" type="button" role="tab"
                                                    aria-controls="nav-contacts" aria-selected="false">Ranking</button>

                                                <button class="nav-link" id="nav-notes-tabs" data-bs-toggle="tab"
                                                    data-bs-target="#nav-notes" type="button" role="tab"
                                                    aria-controls="nav-notes" aria-selected="false">Accomadation</button>

                                                <button class="nav-link" id="nav-tabing-tabs" data-bs-toggle="tab"
                                                    data-bs-target="#nav-tabing" type="button" role="tab"
                                                    aria-controls="nav-tabing" aria-selected="false">Accreditation</button>

                                                <button class="nav-link" id="nav-place-tabs" data-bs-toggle="tab"
                                                    data-bs-target="#nav-place" type="button" role="tab"
                                                    aria-controls="nav-place" aria-selected="false">Placement</button>
                                                <button class="nav-link" id="nav-con-tabs" data-bs-toggle="tab"
                                                    data-bs-target="#nav-con" type="button" role="tab"
                                                    aria-controls="nav-con" aria-selected="false">Notes</button>
                                            </div>
                                        </nav>
                                        ...
                                        <div class="tab-content " id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade {{ isset($_GET['tab']) && $_GET['tab'] === 'programs' ? 'active show' : '' }}" id="nav-profile" role="tabpanel"
                                                ...
                                                <div class="ehl-heading mt-3">
                                                    <div class="text-ehl-title">
                                                        <h2 class="fw-bold">All Courses Offered</h2>
                                                    </div>
                                                    @forelse ($program as $item )
                                                    <div
                                                        class="secong-ehl-text d-flex justify-content-between gap-2 align-items">
                                                    ...
                                                    <div class="content-part mt-3">
                                                        <ul class="meta-part">
                                                            ...
                                                            <li class="user"><i class="fa fa-money"></i> <span
                                                                ...
                                                                <span>{{ $item->application_fee }}</span></li>
                                                            <li class="user">
