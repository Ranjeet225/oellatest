...
<body>
            ...
            <div class="container ">
                <nav>
                    ...
                    <ul class="nav_links d-flex" id="nav_links">
                        ...
                        <!-- Modal -->
                        <li>
                            <a class="apply-btn rounded fn border-0 p-2" href="{{ route('check-eligible') }}"> Quick Search
                            </a>
                        </li>
                        <li>
 ...
 <section>
<div class="whats-icon-title">
    <div class="icon-chat-whatsup">
