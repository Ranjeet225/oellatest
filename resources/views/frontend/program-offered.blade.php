...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12 col-mg-12 col-xs-12 col-sm-12">
                        ...
                        <div class="universities_heading text-center">
                            <h1 class="fw-medium mx_rounded text-black">Courses Offered</h1>
                        </div>
                        <div class="serch-bar-title">
                        <nav class="navbar navbar-light ">
                        <div class="container-fluid justify-content-center">
                            <form class="d-flex bg-white extra-bg">
                            <input class="form-control form-ct-int content-bg me-2" type="search" placeholder="Search" aria-label="Search">
                            <button class="btn btn-outline-success" type="submit">Search Course</button>
                            </form>
                        </div>
                        </nav>
                        </div>
    ...
    <section>
        <div class="overseas_cast_edu mt-5">
            <div class="container">
