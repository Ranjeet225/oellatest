        ...
        <div id="container" class="container ">
            ...
            <form id="multi-step-form">
                <div class="step step-1">
                   ...
                   <button type="button" class="btn btn-primary prev-step px-4">Previous</button>
                ...
                <div class="step step-4">
                    <div class="step-78 text-center">
                        <h2>Program Discipline?</h2>
                       </div>
                       <div class="container"></div>
                       <input type="checkbox" class="input-box" id="input-box" placeholder="" >
                ...
                <div class="step step-5">
                    <div class="step-78 text-center">
                        ...
                        <P>Scoring high in language tests increases your options multi fold.</P>
                        <ul class="mt-4">
                            <li><button>IELTS</button></li>
                            <li><button>PET</button></li>
                            <li><button>DET</button></li>
                            <li><button>NO ANY TAKEN TEST</button></li>
                            <li><button>TOEFL</button></li>
                        </ul>
                       </div>
                       <div class="input-tiles">
                        <input type="text" class="control px-3" id="cotrol-gh" placeholder="Enter Your Score">
                       </div>
                ...
                <div class="step step-6">
                    <div class="step-78 text-center">
                        ...
                        <ul class="mt-4">
                            ...
                            <li><button>ACt</button></li>
                            <li><button>NEET</button></li>
                            <li><button>NO ANY TAKEN TEST</button></li>
                            <li><button>TOEFL</button></li>
                            <li><button>NOT REQUIRED</button></li>
                            <li><button>WITHOUT ENGLISH PROFICIENCY</button></li>
                        </ul>
                       </div>
                       <div class="d-flex justify-content-between mt-5">
                    <button type="button" class="btn btn-primary prev-step">Previous</button>
                ...
                <div class="step step-7">
                    <div class="opt-group">
                    <label class="wrapper" for="states">Do you have passport?</label>
                    <div class="button dropdown">
                      <select id="colorselector">
                        <option value="red">Select</option>
                         <option value="red">yes</option>
                         <option value="yellow">No</option>
                            ...
                            <div class="col-lg-6">
                                <div class="country-title-trp">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control hmb-cnt" id="formGroupExampleInput" placeholder="dd-mm-yy">
                                      </div>
                                </div>
