                    ...
                    <div class="wizard">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" role="tabpanel" id="step1"
                                ...
                                @endif
                                <form class="row g-4" action="{{ route('update-feedbackvideo', $feedbackvideo->id) }}" method="POST"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="video" class="form-control " maxlength="200"  />
                                        @error('video')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
