                ...
                <div class="card-stretch-full">
                    <div class="row g-4">
                        <form class="row g-4" id="score-data">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select class="form-control " name="master_service" id="usr-fees_type" placeholder="Type" required onchange="getSubService(this.value)">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <select class="form-control " name="sub_service[]" multiple id="usr-sub_service" placeholder="Type" required>
