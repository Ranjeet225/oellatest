                   ...
                   <div class="nav nav-tabs tabs-mp  mb-3" id="nav-tab" role="tablist">
                      <button class="nav-link nav-con-link  active position-relative p-3 mt-3" id="nav-home-tab"
                         ...
                         <div class="st-title-login">
                            <img src="{{ asset('frontend/img/student.png') }}" alt="student">
                               ...
                               <div class="row">
                                  <div class="col-lg-7">
                                     <div class="one-sight-bold">
                                        <img src="{{ asset('frontend/img/n6-removebg-preview.png') }}" alt="n6">
                                     </div>
                                  </div>
                                  <div class="col-lg-4">
                            ...
                            <div class="row">
                               <div class="col-lg-4">
                                  <div class="admission-login">
                                     <img src="{{ asset('frontend/img/OEL--BANNER.png') }}" class="w-100"   alt="admission">
                                  </div>
                               </div>
                               <div class="col-lg-8">
                         ...
                         <div class="container">
                            <div class="bn-part--student">
                               ...
                               <div class="bn-st--student d-flex gap-4 bg-white ">
                                  <div class="cn-counselling">
                                     <img src="{{ asset('frontend/img/4.png') }}" alt="brand">
                                  </div>
                                  <div class="right-brand-st mt-2">
                                     <h3 class="fw-bold">COUNCELLING</h3>
                            ...
                            <div class="bn-part--student">
                               <div class="bn-st--student d-flex gap-4 bg-white mt-5 flp ">
                                  <div class="cn-counselling">
                                     <img src="{{ asset('frontend/img/3.png') }}" alt="brand">
                                  </div>
                                  <div class="right-brand-st mt-2">
                                     <h3 class="fw-bold text-end">ADMISSION</h3>
                                     <P class="text-end">  Studying abroad offers a transformative opportunity for personal
                            ...
                            <div class="bn-part--student">
                               <div class="bn-st--student d-flex gap-4 bg-white mt-5 ">
                                  <div class="cn-counselling">
                                     <img src="{{ asset('frontend/img/2.png') }}" alt="brand">
                                  </div>
                                  <div class="right-brand-st mt-2">
                                     <h3 class="fw-bold ">VISA ASSITANCE</h3>
                                     <P class="">Applying for a student visa involves several critical steps. We ensure that you are well-informed
                            ...
                            <div class="bn-part--student">
                               <div class="bn-st--student d-flex gap-4 bg-white mt-5 flp">
                                  <div class="cn-counselling">
                                     <img src="{{ asset('frontend/img/1.png') }}" alt="brand">
                                  </div>
                                  <div class="right-brand-st mt-2">
                                     <h3 class="text-end">Accomandation</h3>
                                     <P class="text-end">Relocating to a new country, especially at a young age,
                      ...
                      <div class="studentloging-title">
                         <div class="container">
                            <div class="row">
                               <div class="col-lg-4">
                                  <div class="admission-login">
                                     <img src="{{ asset('frontend/img/admission.jpg') }}"  alt="admission">
                                  </div>
                               </div>
                               <div class="col-lg-8">
                                  <div class="student-loging-title--">
                            ...
                            <div class="bn-part--student">
                               ...
                               <div class="main-brand  gap-5">
                                  <div class="bn-st--student d-flex  bg-white ">
                                     ...
                                     <div class="right-brand-st mt-2">
                                        <h3 class="text-center">Comprehensive Information Access</h3>
                                        <P class="text-center tp-text">Franchisees gain exclusive access to a robust database featuring over
                                  ...
                                  <div class="bn-part--student mt-5">
                                     <div class="bn-st--student d-flex  bg-white  ">
                                        ...
                                        <div class="right-brand-st mt-2">
                                           <h3 class="fw-bold text-center">Revenue Potential</h3>
                                           <P class="text-center tp-text">Our industry offers one of the highest returns on investment. 
                               ...
                               <div class="main-brand  gap-5">
                                  <div class="bn-part--student">
                                     <div class="bn-st--student d-flex  bg-white mt-5 ">
                                        ...
                                        <div class="right-brand-st mt-2">
                                           <h3 class="fw-bold text-center ">Operational Support</h3>
                                           <P class="text-center tp-text">We provide extensive support to franchisees, including hands-on training and onboarding
                                  ...
                                  <div class="bn-part--student">
                                     <div class="bn-st--student d-flex  bg-white mt-5 ">   
                                        ...
                                        <div class="right-brand-st mt-2">
                                           <h3 class="text-center">Holistic Client Management</h3>
                                           <P class="text-center tp-text">We assist franchisees throughout the entire client
            ...
            <div class="container">
                <div class="bn-part--student">
                    ...
                    <div class="bn-st--student d-flex gap-4 bg-white ">
                        ...
                        <div class="right-brand-st mt-2">
                            <h3 class="fw-bold">LANGUAGE COUNSELLOR</h3>
                            <P>Language counsellors provide education to students in order to assist them understand the
                ...
                <div class="bn-part--student">
                    <div class="bn-st--student d-flex gap-4 bg-white mt-5 flex-row-reverse">
                        ...
                        <div class="right-brand-st mt-2 mx-2">
                            <h3 class="fw-bold text-end">Career Counsellor</h3>
                            <P class="text-end">
                ...
                <div class="bn-part--student">
                    <div class="bn-st--student d-flex gap-4 bg-white mt-5 ">
                        ...
                        <div class="right-brand-st mt-2">
                            <h3 class="fw-bold ">EDUCATION COUNSELOR</h3>
                            <P class="">Education counselors focus on providing guidance and career advice to 
                ...
                <div class="bn-part--student">
                    <div class="bn-st--student d-flex gap-4 bg-white mt-5 flex-row-reverse">
                        ...
                        <div class="right-brand-st mt-2">
                            <h3 class="text-end">ESSAY WRITING COUNSELORS</h3>
                            <P class="text-end">
                              ...
                              Add- Join OEL–> and direct it to counselor login.
                            </P>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="sec-title3 pl-65 md-pl-15 wow fadeInUp" data-wow-delay="300ms"
                            ...
                            <div>
                                <p style="text-align:left;">Our mission is to promote higher education at the international
                                    level and to provide quality counselling services to students wishing to enrol abroad.
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:left;">An overseas education adviser is essential in
                                            ...
                                            Admission Processing and Documentation. the counsellors will help you filing for
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:right;">By studying abroad, you are allowing yourself to
                                            ...
                                            top firms. Counsellors at OEL assist you in choosing the best college for you
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:right;">Moving to another nation, especially at a young age,
                                            ...
                                            to living abroad.Our counsellors help with you and your parents to choose the
                ...
                <div class="col-lg-9">
                    <div class="content-part">
                        ...
                        <div class="sec-title3 pl-65 md-pl-15 wow fadeInUp" data-wow-delay="300ms"
                            ...
                            <div class="desc mb-30 pr-50 md-pr-15">
                                <p style="text-align:left">Counselling is important for study abroad. It plays a crucial
                                    role for students who want to study abroad. It specifically helps scholars to find the
                                    right academic institute and the right course to explore. Such overseas counsellors can
                                ...
                                <p style="text-align:left">The counselors' help in choosing a study destination and
                                    ...
                                    preparation for your English test and visa application support. Our counsellors also
                                    help with your accommodation. Not just this, they also perform career counselling and
                    ...
                    <div class="col-lg-12 mb-40">
                        <div class="course-item">
                            ...
                            <div class="course-info">
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:left;">Language counsellors provide education to students in
                    ...
                    <div class="col-lg-12 mb-40">
                        <div class="course-item">
                            <div class="course-info">
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:right;">A career counsellor is a professional who assists
                                            people in choosing a career and achieving their professional objectives.
                                            Counsellors assist clients in entering the labour field, changing jobs, and
                                            ...
                                            organisations. Choosing a career can be difficult. A career counsellor is a
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:left;">AN education counselor’s work is to provide counselling
                                            ...
                                            counsellors keep an eye on the personal/social and behavioural problems which
                                            may affect their academic life. It is not just job; you can make a difference by
                                            helping students make their career. The job of an education counsellor is quite
                                ...
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <p style="text-align:right;">Admission essays, also known as application essays,
                                            ...
                                            counsellor provides assistance to students to write an impactful and impressive
                                            ...
                                            study?" clearly and neatly. These counsellors help with writing admission essays
